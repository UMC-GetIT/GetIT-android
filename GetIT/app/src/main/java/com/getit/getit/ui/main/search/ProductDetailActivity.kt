...
lateinit var binding: FragmentProductDetailBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 더미데이터
        reviewDatas.apply {
            add(Reviews(R.drawable.samsong_labtop_img ,"재니퍼", "역대급 성능입니다! 웬만한 작업으로는 팬도 안 돌아가서 소음도 느껴지지 않네요. 강추합니다! 역대급 성능입니다! 웬만한 작업으로는 팬도 안 돌아가서 소음도 느껴지지 않네요. 강추합니다!"))
            add(Reviews(R.drawable.samsong_labtop_img ,"지온", "저는 포토샵이나 파이널컷 프로 정도 살짝 건드리는 수준인데 약간 오버스펙인 면이 없지 않아있지만 만족합니다."))
            add(Reviews(R.drawable.samsong_labtop_img ,"설기", "상자 뜯는 재미가 있어서 좋았습니다. 성능이 상상을 초월하네요 기대하고 구매했는데 잘 사용하겠습니다."))
        }
